  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 py-4 text-center text-4xl font-medium tracking-tight text-transparent bg-black bg-clip-text md:text-7xl"
      >
        <h2 className="text-3xl font-thin text-black mb-6">
          Our Story
        </h2>
  ...
  return (
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0">
        ...
        >
          <div className="absolute w-40 h-[100%] left-0 bg-black bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        ...
        >
          ...
          <div className="absolute w-40 h-40 right-0 bg-black bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        </motion.div>
