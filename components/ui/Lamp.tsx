    ...
    <LampContainer>
      ...
      >
        <h2 className="text-3xl   font-thin text-black mb-6">
          ...
          training and sustainable job creation, we empower our weavers and we are working on this AI which solve humans problem in daily task which we are is these day"
    ...
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          ...
          <div className="absolute  w-[100%] right-0 bg-blackh-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        </motion.div>
